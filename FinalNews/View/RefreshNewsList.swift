...
struct RefreshNewsList: UIViewRepresentable {
	var width: CGFloat
	var height: CGFloat
	...
	class Coordinator: NSObject {
		var refreshScrollView: RefreshNewsList
		var fetch: NewsContent
		
		init(_ refreshScrollView: RefreshNewsList, refresh: NewsContent) {
